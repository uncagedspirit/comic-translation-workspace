...
## Current Status
- Phase: H (Export)
- Completed: [project initialized, dependencies installed, file structure created, Zustand store, upload flow, page canvas, bubble drawing & selection, text-fit algorithm, translation panel + live text preview]
- In Progress: Export
- Blocked: None